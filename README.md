  ...
  Answer simple questioins to create a professional README
  ...
  * [Contact](#questions)
  ...
  Once you have cloned the repo to a local machine and are in that main branch, you will need to run NPM i to install all node modules. Then you can run node index to answwer questions.
